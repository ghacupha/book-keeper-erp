...
@WithMockUser
@EmbeddedKafka
class BookKeeperErpKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/book-keeper-erp-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/book-keeper-erp-kafka/consume")
