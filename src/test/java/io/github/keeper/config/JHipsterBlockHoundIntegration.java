package io.github.keeper.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("io.github.keeper.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("io.github.keeper.security.DomainUserDetailsService", "createSpringSecurityUser");
