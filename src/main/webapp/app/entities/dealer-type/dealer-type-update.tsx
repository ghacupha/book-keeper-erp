...
import { getEntity, updateEntity, createEntity, reset } from './dealer-type.reducer';

export const DealerTypeUpdate = () => {
  ...
  const loading = useAppSelector(state => state.dealerType.loading);
  const updating = useAppSelector(state => state.dealerType.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bookKeeperErpApp.dealerType.home.createOrEditLabel" data-cy="DealerTypeCreateUpdateHeading">
...
export default DealerTypeUpdate;
