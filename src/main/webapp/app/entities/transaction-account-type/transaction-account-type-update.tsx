...
import { getEntity, updateEntity, createEntity, reset } from './transaction-account-type.reducer';

export const TransactionAccountTypeUpdate = () => {
  ...
  const loading = useAppSelector(state => state.transactionAccountType.loading);
  const updating = useAppSelector(state => state.transactionAccountType.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bookKeeperErpApp.transactionAccountType.home.createOrEditLabel" data-cy="TransactionAccountTypeCreateUpdateHeading">
...
export default TransactionAccountTypeUpdate;
